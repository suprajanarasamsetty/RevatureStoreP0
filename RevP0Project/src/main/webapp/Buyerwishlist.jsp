...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to right, #e8f5e9, #a5d6a7); /* Light green gradient */
        ...
        .navbar-nav .nav-link:hover {
            color: #c8e6c9 !important; /* Light green hover effect */
        }
        .container {
            margin-top: 30px;
            padding: 30px;
        ...
        .card-header {
            background-color: #388e3c; /* Green card header */
            color: white;
            font-weight: bold;
        }
        .btn-primary {
